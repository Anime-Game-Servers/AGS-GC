...
public enum QuestContent implements QuestTrigger {
    ...
    QUEST_CONTENT_FINISH_ITEM_GIVING (27), // finish
    ...
    QUEST_CONTENT_BARGAIN_SUCC (124), // finish
    QUEST_CONTENT_BARGAIN_FAIL (125),// fail
    QUEST_CONTENT_ITEM_LESS_THAN_BARGAIN (126),// fail
    QUEST_CONTENT_ACTIVITY_TRIGGER_FAILED (127),// missing, fail
    QUEST_CONTENT_MAIN_COOP_ENTER_SAVE_POINT (128),// finish
    QUEST_CONTENT_ANY_MANUAL_TRANSPORT (129),
    QUEST_CONTENT_USE_ITEM (130),
    QUEST_CONTENT_MAIN_COOP_ENTER_ANY_SAVE_POINT (131),// finish and fail
    ...
    QUEST_CONTENT_SCENE_LEVEL_TAG_EQ (148),// finish
